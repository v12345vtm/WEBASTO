...
String versie = "concept3.ino = getest op PCB" ; //sketch versie
...
String lcdknopfunctie1 = "*" ;//lcd menu toetsfuncties
String lcdknopfunctie2 = "*" ;
String lcdknopfunctie3 = "*" ;
String lcdknopfunctie4 = "*" ;
...
#define alarm_lower_limit 20 //0tot 100 graden voor het systeem ontploft en we tijdig alles kunnen stoppen
...
// initialize the library with the numbers of the interface pins LCD=20
LiquidCrystal lcd(32, 30, 28, 26, 24, 22); // RS , E , D4 , D5 , D6 , D7=20 aanpassing leraar
...
void loop() {
  ...
  //  Serial.print("pompvrijgave:\t"); Serial.print(bitRead(meerstandenschakelaar[stand] , 2)); Serial.println(" ");
    ...
    if (bitRead(meerstandenschakelaar[stand] , 2)== HIGH)
    {set_pwm_pomp (pwm_procent);}
...
//inschakelvertraging
 ...
 lcd.setCursor(0, 0); 
   lcd.print(menustructuur); lcd.print(" ");
    lcd.setCursor(2, 0); 
    lcd.print(pwm_procent);lcd.print(" ");
      lcd.setCursor(6, 0); 
     lcd.print(Sleeptimer); lcd.print(" ");
       lcd.setCursor(10, 0); 
 lcd.print(alarmTemp); lcd.print(" ");
          lcd.setCursor(14, 0); 
 lcd.print(gewensteTemp); lcd.print(" ");
   
 lcd.setCursor(0, 1);
      lcd.print("                ");
 lcd.setCursor(0, 1);
   lcd.print(lcdknopfunctie4);
    lcd.print(lcdknopfunctie3);
 lcd.print(lcdknopfunctie2);
 lcd.print(lcdknopfunctie1);
...
void flowshartmenustructuurLCD() {
 ...
 inschakelvertraging  = 14 ;
   ...
   lcdknopfunctie1 = " +" + String(stap);
      lcdknopfunctie2 = "  -" +  String(stap);
      lcdknopfunctie3 = "  /" +  String(nextstap);
      lcdknopfunctie4 = "sve";
